...
export function ServicesPage() {
  ...
  return (
    <div className="services-page bg-[#2C3639] min-h-screen">
      <LoginNavbarCarouselApp videoSrc="/assets/servicios.mp4">
        <motion.h1
      ...
      {/* Header */}
      <div className="text-center py-16 bg-[#3F4E4F] text-[#DCD7C9]">
        <h1 className="text-4xl font-bold mb-4 text-[#A27B5C]">Servicios Disponibles</h1>
      ...
      {/* Filter Icons */}
      <div className="flex justify-center gap-6 py-8 bg-[#2C3639] text-[#DCD7C9]">
        <button
          onClick={() => setSelectedCategory("")}
          className={`flex flex-col items-center text-center rounded-full p-4 ${
            selectedCategory === "" ? "text-[#DCD7C9] bg-[#A27B5C]" : "text-[#DCD7C9] bg-[#3F4E4F]"
          } hover:text-[#DCD7C9] hover:scale-110 transition-transform duration-300`}
        >
          <div
        ...
        <button
          ...
          className={`flex flex-col items-center text-center rounded-full p-4 ${
            selectedCategory === "corporales" ? "text-[#DCD7C9] bg-[#A27B5C]" : "text-[#DCD7C9] bg-[#3F4E4F]"
          } hover:text-[#DCD7C9] hover:scale-110 transition-transform duration-300`}
        >
          <div
            className={`w-16 h-16 flex items-center justify-center rounded-full ${
        ...
        <button
          ...
          className={`flex flex-col items-center text-center rounded-full p-4 ${
            selectedCategory === "masajes" ? "text-[#DCD7C9] bg-[#A27B5C]" : "text-[#DCD7C9] bg-[#3F4E4F]"
          } hover:text-[#DCD7C9] hover:scale-110 transition-transform duration-300`}
        >
          <div
            className={`w-16 h-16 flex items-center justify-center rounded-full ${
        ...
        <button
          ...
          className={`flex flex-col items-center text-center rounded-full p-4 ${
            selectedCategory === "faciales" ? "text-[#DCD7C9] bg-[#A27B5C]" : "text-[#DCD7C9] bg-[#3F4E4F]"
          } hover:text-[#DCD7C9] hover:scale-110 transition-transform duration-300`}
        >
          <div
            className={`w-16 h-16 flex items-center justify-center rounded-full ${
        ...
        <button
          ...
          className={`flex flex-col items-center text-center rounded-full p-4 ${
            selectedCategory === "grupales" ? "text-[#DCD7C9] bg-[#A27B5C]" : "text-[#DCD7C9] bg-[#3F4E4F]"
          } hover:text-[#DCD7C9] hover:scale-110 transition-transform duration-300`}
        >
          <div
            className={`w-16 h-16 flex items-center justify-center rounded-full ${
      ...
      {/* Services Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-8 py-16 bg-[#2C3639]">
        {services
          .filter((service) => 
          ...
          .map((service) => (
            <div
              key={service.id}
              className="bg-[#3F4E4F] text-[#DCD7C9] rounded-lg shadow-lg overflow-hidden 
              hover:shadow-xl transition-all duration-300 hover:scale-105 border border-[#4A5759]"
            >
              <img
              ...
              />
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-2 text-[#A27B5C]">{service.titulo}</h2>
