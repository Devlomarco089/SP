...
const ReservaModal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage("");
      onSuccess(); // Llama a la función de éxito para actualizar la página
  ...
  return (
    ...
    >
      <div className="bg-[#3F4E4F] text-[#DCD7C9] rounded-lg shadow-lg p-8 w-[600px]">
        ...
        <button
          onClick={onClose}
          className="mt-4 w-full px-4 py-2 bg-[#4A5759] text-[#DCD7C9] font-bold rounded-lg shadow-md hover:bg-[#A27B5C] transition duration-300"
        >
          Cancelar
        </button>
      </div>
