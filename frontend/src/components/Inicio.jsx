...
export function Inicio() {
    ...
    return (
        <div className="bg-[#2C3639] min-h-screen font-serif">
            {/* Navbar */}
            <LoginNavbarCarouselApp videoSrc="/assets/inicio.mp4">
                <motion.div
                ...
                {!isAuthenticated ? (
                    <div className="flex gap-4 mb-8">
                        <Link
                            to="/login"
                            className="text-lg px-8 py-3 bg-[#3F4E4F] text-[#DCD7C9] rounded-lg 
                            shadow-xl hover:bg-[#4A5759] hover:shadow-2xl hover:scale-105 
                            transition-all duration-300 border border-[#A27B5C]"
                        >
                            Iniciar Sesión
                        </Link>
                        <Link
                            to="/register"
                            className="text-lg px-8 py-3 bg-[#A27B5C] text-[#DCD7C9] rounded-lg 
                            shadow-xl hover:bg-[#4A5759] hover:shadow-2xl hover:scale-105 
                    ...
                    <div className="flex gap-4 mb-8">
                        <p className="text-lg text-[#DCD7C9]">¡Bienvenido de nuevo!</p>
                    </div>
                )}
            ...
            {/* Hero Section */}
            <div className="inicio-page text-center py-16 bg-[#3F4E4F] text-[#DCD7C9]">
            ...
            {/* Services Section */}
            <div className="py-16 bg-[#2C3639] text-center">
                <h1 className="services-title text-2xl font-bold text-[#DCD7C9] mb-6">
                    Servicios Disponibles
                </h1>
                <p className="services-description text-lg text-[#DCD7C9] mb-8">
            ...
            {/* About Section */}
            <div className="py-16 px-8 bg-[#4A5759] text-[#DCD7C9]">
                <h1 className="text-3xl font-bold text-center mb-6">Acerca de Nosotros</h1>
                <p className="services-description text-lg leading-relaxed max-w-4xl mx-auto">
            ...
            {/* FAQ Section */}
            <div className="py-16 px-8 bg-[#3F4E4F] text-[#DCD7C9]">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-8">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={index} className="border-b border-[#4A5759] pb-4">
                                    ...
                                    >
                                        <h2 className="text-lg font-bold text-[#A27B5C]">{faq.question}</h2>
                                        <span
                                    ...
                                    {openQuestion === index && (
                                        <p className="text-sm mt-2 text-[#DCD7C9]">{faq.answer}</p>
                                    )}
                                </li>
                            ))}
                        </ul>
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        <h2 className="text-lg font-bold mb-4 text-[#A27B5C]">¿Necesitas más ayuda?</h2>
